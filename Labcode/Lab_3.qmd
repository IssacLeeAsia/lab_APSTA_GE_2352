...
-   Questions?
-   Attendance: Scan the QR code. ![Attendance](images/frame.png){.absolute bottom="0" right="70" width="300" height="300"}
...
-   Good luck!
    -   Lab Materials:
      -   Lab Materials: ![Attendance](images/github.png){.absolute bottom="0" right="70" width="300" height="300"}
